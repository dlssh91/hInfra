...
def main():
    ...
    prev = {j["item_id"]: j for j in
            json.load(open(ROOT / "out/db_mysql_experiment/qwen3-coder_30b/run1/result.json"))["judgments"]}
    ...
    print(f"\n{'항목':<12} {'v3(이전)':<8} {'v4-r1':<8} {'v4-r2':<8} {'v4-r3':<8} {'Opus':<8} 변화")
    print("-" * 72)
